...
render() {
    return <div>
        <div className="form-group">
                ...
                <input type="text" id="caption" name="caption" className="form-control" required maxLength="40" value={this.state.caption} onChange={(e) => this.setState({caption:e.target.files[0]})}/>
                </div>
